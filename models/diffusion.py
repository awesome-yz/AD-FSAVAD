...
from models.diffaug import DiffAugment
from models.adaaug import AdaAugment
...
class Diffusion(torch.nn.Module):
    ...
    def update_T(self):
        ...
        diffusion_ind = 32
        t_diffusion = np.zeros((diffusion_ind,)).astype(np.int64)
    ...
    def forward(self, x_0):
        ...
        x_t, noise = q_sample(x_0, alphas_bar_sqrt, one_minus_alphas_bar_sqrt, t,
