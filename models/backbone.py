...
class Encoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks, 
        ...
        self.temb_ch = 0 # no timesteps
        self.num_resolutions = len(ch_mult) # num of internal blocks
        self.num_res_blocks = num_res_blocks # resnet blocks
        self.resolution = resolution # image size 
        self.in_channels = in_channels # input channels
     
        # downsampling
        # expanding in the channels dimensions
        self.conv_in = nn.Conv2d(in_channels, 
                                 ...
                                 padding=1) 
        curr_res = resolution
        in_ch_mult = (1,)+tuple(ch_mult) # prepending 1 to the tuple list for input channels
